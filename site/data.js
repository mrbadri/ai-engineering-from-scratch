...
// Last built: 2026-07-30T06:39:48.502Z
    ...
    "lessons": [
      {
        ...
        "i18n": {
          "fa": {
            "name": "محیط توسعه",
            "summary": "ابزارهای شما شیوهٔ فکرتان را شکل می‌دهند. آن‌ها را یک‌بار، درست پیکربندی کنید.",
            "keywords": "گام 1: system foundation (زیربنای سیستم) · گام 2: Python با uv · گام 3: Node.js با pnpm · گام 4: Rust · گام 5: Julia (اختیاری) · گام 6: GPU setup (راه‌اندازی GPU؛ اگر GPU دارید) · گام 7: verification (بررسی) همه‌چیز"
          }
        },
        "quizLangs": [
          "fa"
      ...
      },
      {
        ...
        "i18n": {
          "fa": {
            ...
            "summary": "version control (کنترل نسخه) اختیاری نیست. هر آزمایش، هر مدل و هر درسی که اینجا می‌سازید، ثبت و پیگیری می‌شود.",
            "keywords": "گام 1: Git را پیکربندی کنید · گام 2: daily workflow (گردش‌کار روزانه) · گام 3: branching (شاخه‌سازی) برای آزمایش‌ها · گام 4: کار با course repository (مخزن دوره)"
          }
        },
        "quizLangs": [
          "fa"
      ...
      },
      {
        ...
        "i18n": {
          "fa": {
            "name": "راه‌اندازی GPU و رایانش ابری",
            "summary": "آموزش روی CPU برای یادگیری کافی است؛ آموزش جدی به GPU نیاز دارد.",
            "keywords": "گزینه 1: local NVIDIA GPU (GPU محلی NVIDIA) · گزینه 2: Google Colab · گزینه 3: cloud GPU (GPU ابری) · GPU ندارید؟ مشکلی نیست."
          }
        },
        "quizLangs": [
          "fa"
