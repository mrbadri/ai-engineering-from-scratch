...
(function () {
  ...
  STRINGS.en = {
    ...
    'index.attribution_html': 'Based on the <a href="https://github.com/rohitg00/ai-engineering-from-scratch" target="_blank" rel="noopener">original repository</a>. Maintained by <span class="i18n-id">@mrbadri</span> and contributors.',
    'index.starOnGithub': 'Star on GitHub',
    'index.followAuthor_html': 'Follow <span class="i18n-id">@mrbadri</span>',
    'index.persianCommunity': 'Persian Community',
  ...
  STRINGS.fa = {
    ...
    'index.attribution_html': 'برگرفته از <a href="https://github.com/rohitg00/ai-engineering-from-scratch" target="_blank" rel="noopener">مخزن اصلی</a>. نگهداری‌شده توسط <span class="i18n-id">@mrbadri</span> و مشارکت‌کنندگان.',
    'index.starOnGithub': 'ستاره در گیت‌هاب',
    'index.followAuthor_html': 'دنبال کردن <span class="i18n-id">@mrbadri</span>',
    'index.persianCommunity': 'جامعهٔ فارسی',
